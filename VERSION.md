...
- **v1.2.0** · **2026-09-14**
  - 增加价源日期自动注入脚本 inject_price_source_dates.py；更新科学养鱼 09-14 批发价数据（鳜鱼 12 条、加州鲈 11 条）；统一刷新 MOA/科学养鱼/a渔业行情/塘口价快照所有价源日期标签
  - 农业农村部接口爬虫运行正常，`fish_prices.csv` 已累积至 2026-09-14；当日活鳜鱼接口仍返回 data=null，鲈鱼返回 7 条样本
