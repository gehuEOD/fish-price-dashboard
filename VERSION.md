...
| 版本 | 日期 | 变更摘要 |
|------|------|---------|
| **v1.4.2** | 2026-09-22 | 科学养鱼 09-21 批发价更新（鳜鱼12条+加州鲈12条，环比09-17） |

| **v1.4.1** | 2026-09-20 | a渔业行情9.15塘口价(鳜鱼8+加州鲈7,9.17发布,环比9.14) + 盛阳9.20批发价(鳜鱼35~40/鲈鱼10~14.5) + build_a_section支持文章发布日期与未录入说明 |

| **v1.4.0** | 2026-09-17 | 科学养鱼09-17数据(鳜鱼12+加州鲈12,环比09-14) + a渔业行情9.14数据恢复(环比08-19) + wechat_ocr_pipeline支持vs环比列 + 数据落快照/current.json防每日rebuild回滚 |

| **v1.3.2** | 2026-09-17 | 修复布局: .wrap容器闭合点原在第八区块后(1777行),导致九/十/十一区块超出1180px容器占满视口; 下移闭合点至验收区块后,全页宽度一致 |
